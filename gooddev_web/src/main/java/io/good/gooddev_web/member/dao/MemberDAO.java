...
public interface MemberDAO { 
  ...
  Boolean ValidId(String mid);  // 아이디 유효성 검사 (존재하는지)
  Boolean resetPassword(String mid, String email, String newPassword);  // 비밀번호 재설정
  Boolean EmailValid(String email);  // 이메일 유효성 검사
